...
def compute_metrics(y_true, y_pred):
    ...
    MAE   – mean absolute error (interpretable: "off by X pickups on average")
    MAPE  – mean absolute percentage error (relative, excludes zero-demand slots)
...
def plot_feature_importance(model, feature_names, model_name, output_dir=None, top_n=20):
    ...
    # plt.show() removed to prevent blocking in terminal
